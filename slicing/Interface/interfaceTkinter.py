...
class MainWindow:
    ...
    def __init__(self, window: tk.Tk):
        ...
        conTela = ttk.Frame(self.window, padding="10")
        conTela.pack(fill='x', side='top')
        conTela.columnconfigure(1, weight=1)
        conTela.columnconfigure(3, weight=1)
        ...
        self.botaoTema = ttk.Button(
            conTela, image=self.iconeTema, command=lambda: self.mudarTema(self.w3))
